...
#define MODPLUG_EXPORT __declspec(dllexport)
        ...
        defined(MODPLUG_STATIC) /* building or using static libmodplug for windows */
...
MODPLUG_EXPORT unsigned int ModPlug_InstrumentName(ModPlugFile* file, unsigned int qual,
                                                   char* buff);
