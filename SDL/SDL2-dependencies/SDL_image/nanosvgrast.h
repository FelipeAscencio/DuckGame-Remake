...
NSVG_EXPORT void nsvgRasterize(NSVGrasterizer* r, NSVGimage* image, float tx, float ty, float scale,
...
static int SDLCALL nsvg__cmpEdge(const void* p, const void* q) {
...
static int nsvg__div255(int x) { return ((x + 1) * 257) >> 16; }
